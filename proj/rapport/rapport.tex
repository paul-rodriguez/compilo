...
\section{Unités lexicales}
	\begin{center}
	    \begin{tabular}{ | l | l |}
	    	\hline Nom & Regex \\
	    	\hline variable & \verb@ $[a-zA-Z_][a-zA-Z0-9_]* @ \\
	    	\hline function & \verb@ [a-zA-Z_][a-zA-Z0-9_]* @ \\
	    	...
	    	\hline openpar & \verb@ \( @ \\
	    	\hline closepar & \verb@ \) @ \\
	    	\hline openbrack & \verb@ \[ @ \\
	    	\hline closerbrack & \verb@ \] @ \\
	    	\hline semocolon & \verb@ ; @ \\
	    	\hline call & \verb@ & @ \\
	    	\hline plus & \verb@ \+ @ \\
	    	\hline minus & \verb@ \- @ \\
	    	\hline mult & \verb@ \* @ \\
	    	...
	    	\hline or & \verb@ || @ \\
	    	\hline eq & \verb@ == @ \\
	    	\hline eqletters & \verb@ eq @ \\
	    	\hline neq & \verb@ != @ \\
	    	\hline neqletters & \verb@ ne @ \\
	    	\hline lt & \verb@ < @ \\
	    	\hline ltletters & \verb@ lt @ \\
	    	\hline gt & \verb@ > @ \\
	    	\hline gtletters & \verb@ gt @ \\
	    	\hline le & \verb@ <= @ \\
	    	\hline leletters & \verb@ le @ \\
	    	\hline ge & \verb@ >= @ \\
	    	\hline geletters & \verb@ ge @ \\
	    	\hline comma & \verb@ , @ \\
	    	\hline point & \verb@ \. @ \\
	    	\hline assign & \verb@ = @ \\
	    	\hline
...
\section{Graphe du DFA}
	...
	\begin{tikzpicture}[node distance=3cm,on grid,auto]
		...
		\node[state,accepting] (22) [right of=19] {openpar};
			\path[->] (0) edge node{(} (22);
		\node[state,accepting] (23) [right of=22] {closepar};
			\path[->] (0) edge node{)} (23);
		\node[state,accepting] (24) [below of=23] {openbrack};
			\path[->] (0) edge node{[} (24);
		\node[state,accepting] (25) [below of=24] {closebrack};
			\path[->] (0) edge node{]} (25);
