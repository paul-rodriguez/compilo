...
\section{DFA}
	...
	\subsection{Else, elseif et identifier}
		\begin{tikzpicture}[node distance=3cm,on grid,auto]
			\node[initial,initial text=,state] (0) {};
			\node[state] (1) [right of=0] {};
				\path[->] (0) edge node{e} (1);
			\node[state,accepting] (11) [above of=1] {identifier};
				\path[->] (1) edge node{other} (11);
			...
			\node[state,accepting] (5) [right of=4] {else};
				\path[->] (4) edge node{other} (5);
			\node[state] (6) [below of=4] {};
				\path[->] (4) edge node{i} (6);
			\node[state,accepting] (12) [right of=6] {identifier};
				\path[->] (6) edge node{other} (12);
			\node[state] (7) [below of=6] {};
				\path[->] (6) edge node{f} (7);
			\node[state,accepting] (8) [right of=7] {elseif};
			...
			\node[state] (9) [below=6cm of 1] {};
				...
				\path[->] (3) edge[above right] node{[a-df-zA-Z0-9\_]} (9);
				\path[->] (4) edge node{[a-hj-zA-Z0-9\_]} (9);
				\path[->] (6) edge[below] node{[a-eg-zA-Z0-9\_]} (9);
				\path[->] (7) edge[below left] node{[a-zA-Z0-9\_]} (9);
